<%-- 
    Document   : printRegistration
    Created on : Dec 2, 2018, 7:08:31 PM
    Author     : Shubham Nehe
--%>
    ...
    <body>
        <%
            ...
            } else if(session.getAttribute("registrar_user").equals("registrar")) 
           {
               ...
               Student_data stud=(Student_data)StudCon.getStudentInfo(request.getParameter("rollno"));
               String homePath="";
        %>
              ...
              <!--Printing student details--> 
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        ...
                        <table border="1" text-align="center">
                            ...
                            <% 
                               List list=StudCon.getRegCourse(stud.getRollno(),stud.getTerm(),new Integer(stud.getYear()));
                               try{List list1=StudCon.getBackCourse(stud.getRollno());}catch(Exception e){}
                               Courses course;
                ...
                <div class="row">                         
                       <form method="post">  
                           ...
                           <div class="col-sm-3">
                               <% homePath="studRegList.jsp?year="+stud.getYear()+"&term="+stud.getTerm()+"&shift="+stud.getShift(); %>
                                <button id="homeBtn" value="Home" formaction="<%=homePath%>" class="btn btn-lg btn-primary">Home</button>
                           </div>
                       </form> 
                </div> 
                <%}catch(Exception e){System.out.print("_______________Exception = "+e);}%>
          </div>
                    ...
                    <div class="col-lg-10">
                        <table border="1" text-align="center">
                            ...
                            <tr> 
                                ...
                                <td><%if(exreg.getEx_back()!=1){out.print("X");}else{out.print("*");}%></td> 
                            </tr>
                            <%
                                } 
                            %>
